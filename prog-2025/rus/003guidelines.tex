...
Следующее требование навязано тем, что правила (предписания) должны применяться, а не игнорироваться.
...
Кроме них бывают и другие конфликты, которые мы опустили для краткости изложения. Будем называть множества экземпляров без конфликтов \emph{совместными}.
