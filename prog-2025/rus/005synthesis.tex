...
Чтобы это исправить, мы конструируем максимальное несовместное расположение, а из него получаем все совместные путём поиска конфликтов
...
Это является оптимизаций за счет того, что конфликтующих примитивов расположения меньше, чем не конфликтующих, и поэтому проще получить и недерминированно выкинуть все конфликтующие, чем недетерминированно искать все не конфликтующие.
