...
Google Drive search settings dialog structure rendered  w.r.t. two slightly different versions of JetBrains GUI guidelines~\cite{JBG} using QtQuick Controls\footnote{\url{https://doc.qt.io/qt-5/qtquick-controls2-qmlmodule.html}  (accessed: \DTMDate{2024-11-14})} and Microsoft Universal Design\footnote{\url{https://doc.qt.io/qt-6/qtquickcontrols-universal.html}} theme.
