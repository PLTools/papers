...
с учетом двух немного различных версий предписания, основанного на правилах проектирования интерфейсов от JetBrains~\cite{JBG}, нарисованные с помощью  QtQuick Controls\footnote{\url{https://doc.qt.io/qt-5/qtquick-controls2-qmlmodule.html} (проверено: \DTMDate{2024-11-11})} и темы оформления Microsoft Universal Design\footnote{\url{https://doc.qt.io/qt-6/qtquickcontrols-universal.html}}.
