...
In real applications we may also consider a scope-based optimization for the equation system extension. To achieve this, we only need to introduce a helping function instead of just ``\mintinline{OCaml}|M.add|'' that allows us to deal with scopes.
...
\subsection{Non-persistent Unification}
