...
\begin{figure}[t]
  ...
  \subfloat[Пример интерфейса GUI\label{form1}]{
      \centering
      \includegraphics[scale=0.5]{../form1.png}
  }
  \vskip5mm
  \subfloat[Пример структуры GUI\label{form1-structure}]{
  \scalebox{0.5}{
  \begin{tikzpicture}
    \node[rectangle,draw] (check) at (12, 3) {\includegraphics{../check.png}};
    \node[rectangle,draw] (label) at (9, 0)  {\includegraphics{../label.png}};
    \node[rectangle,draw] (combo) at (15, 0) {\includegraphics{../combo.png}};
    \begin{scope}
...
\subfloat[Пример реального расположения элементов управления\label{form1-layout}]{
  ...
  \begin{tikzpicture}
    ...
    \node[rectangle,draw] (check) at (9.47, 1.6) {\includegraphics{../check.png}};
    \node[rectangle,draw] (label) at (9.01, 0  ) {\includegraphics{../label.png}};
    \node[rectangle,draw] (combo) at (14  , 0  ) {\includegraphics{../combo.png}};
    \begin{scope}
...
\end{tikzpicture}}}
\vskip5mm
\subfloat[Пример правила гайдлайна\label{gdrule}]{
  \includegraphics[scale=0.35]{../jbg-09.png}
}

\caption{Пример GUI: структура, расположение и правило гайдлайна}
...
%there is an order relation between the checkbox and this compositional entity
...
Мы схематично изобразили структуру на рис.~\ref{form1-structure-layout}\subref{form1-structure}.
...
введённого виртуального элемента для пары метка-поле с другим отступом, и всё расположение выровнено влево, что изображено на рис.~\ref{form1-structure-layout}\subref{form1-layout}. В отличие от отношений, использованных при описании структуры,
...
соответствующих частей структуры и при каких условиях. На рис.~\ref{form1-structure-layout}\subref{gdrule}
...
% В PPDP2024 закомменчено то, что ниже
\begin{comment}
