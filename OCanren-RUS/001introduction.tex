...
Они основан на известном метода~\cite{Unparsing, DoWeNeed}  реализации поливариадических функций, и позволяет скрыть процессе реификации (глава \ref{sec:reification}) от программиста-пользователя.
