...
Полноценная реализация алгоритма со всеми оптимизациями требует значительного количества кода, поэтому в этом разделе описаны только её основные элементы. Для простоты примеры кода приводятся на языке программирования \OCaml. Будем считать, что термы заданы следующим алгебраическим типом данных:
