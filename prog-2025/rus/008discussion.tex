...
В будущем стоит попытаться интегрировать целочисленные ограничения в поиск примитивов расположения, так как это позволит раньше избегать неподходящих ответов, что  улучшит производительность.