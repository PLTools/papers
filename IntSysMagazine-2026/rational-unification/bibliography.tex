...
\Bibitem{gauthier2004numbering}
\by N.~Gauthier, F.~Pottier
\paper {Numbering Matters: First-Order Canonical Forms for Second-Order Recursive Types}
\inbook {Proceedings of the 9th {ACM SIGPLAN} International Conference on Functional Programming ({ICFP}~'04)}
\publ {Association for Computing Machinery}
\publaddr {New York, NY, USA}
\yr {2004}
\pages {150--161}
\vol {39}
\crossref {https://doi.org/10.1145/1016850.1016865}
