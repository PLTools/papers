...
с учетом двух немного различных версий предписания, основанного на правилах проектирования интерфейсов от JetBrains~\cite{JBG}, нарисованные с помощью  QtQuick Controls\footnote{\url{https://doc.qt.io/qt-5/qtquick-controls2-qmlmodule.html}} и темы оформления Material Design.
Предписаник регламентирует, что \enquote{слишком длинный} текст должен располагаться под меткой.
